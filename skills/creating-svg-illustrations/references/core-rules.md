...
Always use colors from the slide's color palette (see [../../designing-slide-colors/references/color-palettes.md](../../designing-slide-colors/references/color-palettes.md)).
...
See [../../designing-slide-colors/references/color-palettes.md](../../designing-slide-colors/references/color-palettes.md) for more options including Van Gogh Starry Night palette.
...
- [../../designing-slide-colors/references/color-palettes.md](../../designing-slide-colors/references/color-palettes.md) - Ready-to-use color schemes
