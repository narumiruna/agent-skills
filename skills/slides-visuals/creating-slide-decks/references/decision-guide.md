...
|--------------|----------------|-------------------|
| "Create a slide deck" | Marpit authoring | authoring-marp-slides |
| "Design slide colors" | Color design | designing-slide-colors |
| "Draw a diagram" | SVG illustration | creating-svg-illustrations |
| "Create presentation with brand colors" | Color design -> Marpit | designing-slide-colors -> authoring-marp-slides |
...
- Use `creating-svg-illustrations`
- Use `designing-slide-colors` for palette selection
...
- Use `designing-slide-colors`
- Use `authoring-marp-slides`
- Use `creating-svg-illustrations`
...
### `authoring-marp-slides` (advanced layouts)
...
### `creating-svg-illustrations` (pattern examples)
...
### `designing-slide-colors` (color palettes)
