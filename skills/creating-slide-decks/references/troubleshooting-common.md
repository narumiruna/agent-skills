...
5. Prefer high-contrast palettes from `../../designing-slide-colors/references/color-palettes.md`.
...
- `creating-svg-illustrations` - SVG-specific issues
- `authoring-marp-slides` - Marp consistency and best practices
- `designing-slide-colors` - Color validation checklist
