...
- [x] Frontmatter, OpenAI metadata, and README catalog descriptions remain aligned, verified by all-skill validation, inventory tests, semantic trigger assertions, and manual 32-skill comparison.
